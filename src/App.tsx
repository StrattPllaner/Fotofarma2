...
const Banda = ({ title, left, right, center = false, children }: { title: ReactNode; left?: ReactNode; right?: ReactNode; center?: boolean; children?: ReactNode }) => (
  <div className="relative overflow-hidden bg-brand text-white">
    <span className="lava-1 pointer-events-none absolute -top-24 -right-20 h-64 w-64 rounded-full bg-white/10" aria-hidden="true" />
    <span className="lava-2 pointer-events-none absolute -bottom-32 left-1/4 h-56 w-56 rounded-full bg-brand-strong/30" aria-hidden="true" />
